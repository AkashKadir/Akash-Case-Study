...
<div id="view">
<h3>Select a Plane Id to get details about it</h3>
<table>
	<tr>
		<td id="name">Planes Id</td>
	</tr>
	<c:forEach items="${listOfPlanes}" var="planesList">
	<tr>
	<td><a id="anchorview" href="${pageContext.request.contextPath}/admin/plane/planeId?id=${planesList.planeId}">${planesList.planeId}</a></td>
	</tr>
	</c:forEach>
</table>
</div>

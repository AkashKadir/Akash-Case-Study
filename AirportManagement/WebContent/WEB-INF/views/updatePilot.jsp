...
<a href="${pageContext.request.contextPath}/admin/pilot/view">View Pilots</a>
	...
	<form:form cssClass="formCss"
		action="${pageContext.request.contextPath}/admin/pilot/updatePilot?id=${updatePilot.pilotId}"
		...
		<table>
			<tr>
				...
				<td><form:input path="firstName" id="input" type="text" value="${updatePilot.firstName}"/><span><form:errors
							path="firstName" cssClass="errors"></form:errors></span></td>
			</tr>
			<tr>
				<td id="column">Last Name</td>
				<td><form:input path="lastName" id="input" type="text" value="${updatePilot.lastName}"/><span><form:errors
							path="lastName" cssClass="errors"></form:errors></span></td>
			</tr>
			<tr>
				<td id="column">High School Name</td>
				<td><form:input path="highSchoolName" id="input" type="text" value="${updatePilot.highSchoolName}"/><span><form:errors
							path="highSchoolName" cssClass="errors"></form:errors></span></td>
			</tr>
			<tr>
				<td id="column">University Name</td>
				<td><form:input path="universityName" id="input" type="text" value="${updatePilot.universityName}"/><span><form:errors
							path="universityName" cssClass="errors"></form:errors></span></td>
			</tr>
			<tr>
				<td id="column">Graduated year</td>
				<td><form:input path="graduatedYear" id="input" type="text" value="${updatePilot.graduatedYear}"/><span><form:errors
							path="graduatedYear" cssClass="errors"></form:errors></span></td>
			</tr>
			<tr>
				<td id="column">GPA</td>
				<td><form:input path="gpa" id="input" type="number" value="${updatePilot.gpa}"/><span><form:errors
							path="gpa" cssClass="errors"></form:errors></span></td>
			</tr>
			<tr>
				<td id="column">Experience</td>
				<td><form:input path="experience" id="input" type="number" value="${updatePilot.experience}"/><span><form:errors
